...
procedure CkHttp_getBgLastErrorText(objHandle: HCkHttp; outPropVal: HCkString); stdcall;

function CkHttp__bgLastErrorText(objHandle: HCkHttp): PWideChar; stdcall;

function CkHttp_getBgPercentDone(objHandle: HCkHttp): Integer; stdcall;

procedure CkHttp_getBgResultData(objHandle: HCkHttp; outPropVal: HCkByteData); stdcall;

function CkHttp_getBgResultInt(objHandle: HCkHttp): Integer; stdcall;

procedure CkHttp_getBgResultString(objHandle: HCkHttp; outPropVal: HCkString); stdcall;

function CkHttp__bgResultString(objHandle: HCkHttp): PWideChar; stdcall;

function CkHttp_getBgTaskFinished(objHandle: HCkHttp): wordbool; stdcall;

function CkHttp_getBgTaskRunning(objHandle: HCkHttp): wordbool; stdcall;

function CkHttp_getBgTaskSuccess(objHandle: HCkHttp): wordbool; stdcall;
...
function CkHttp_getEventLogCount(objHandle: HCkHttp): Integer; stdcall;
...
function CkHttp_getKeepEventLog(objHandle: HCkHttp): wordbool; stdcall;

procedure CkHttp_putKeepEventLog(objHandle: HCkHttp; newPropVal: wordbool); stdcall;
...
function CkHttp_getUseBgThread(objHandle: HCkHttp): wordbool; stdcall;

procedure CkHttp_putUseBgThread(objHandle: HCkHttp; newPropVal: wordbool); stdcall;
...
function CkHttp_AddQuickHeader(objHandle: HCkHttp; headerFieldName: PWideChar; headerFieldValue: PWideChar): wordbool; stdcall;

function CkHttp_BgResponseObject(objHandle: HCkHttp): HCkHttpResponse; stdcall;

procedure CkHttp_BgTaskAbort(objHandle: HCkHttp); stdcall;

procedure CkHttp_ClearBgEventLog(objHandle: HCkHttp); stdcall;
...
function CkHttp_EventLogName(objHandle: HCkHttp; index: Integer; outStr: HCkString): wordbool; stdcall;

function CkHttp__eventLogName(objHandle: HCkHttp; index: Integer): PWideChar; stdcall;

function CkHttp_EventLogValue(objHandle: HCkHttp; index: Integer; outStr: HCkString): wordbool; stdcall;

function CkHttp__eventLogValue(objHandle: HCkHttp; index: Integer): PWideChar; stdcall;
...
function CkHttp_RemoveQuickHeader(objHandle: HCkHttp; headerFieldName: PWideChar): wordbool; stdcall;
...
procedure CkHttp_getBgLastErrorText; external DLLName;
function CkHttp__bgLastErrorText; external DLLName;
function CkHttp_getBgPercentDone; external DLLName;
procedure CkHttp_getBgResultData; external DLLName;
function CkHttp_getBgResultInt; external DLLName;
procedure CkHttp_getBgResultString; external DLLName;
function CkHttp__bgResultString; external DLLName;
function CkHttp_getBgTaskFinished; external DLLName;
function CkHttp_getBgTaskRunning; external DLLName;
function CkHttp_getBgTaskSuccess; external DLLName;
...
function CkHttp_getEventLogCount; external DLLName;
...
function CkHttp_getKeepEventLog; external DLLName;
procedure CkHttp_putKeepEventLog; external DLLName;
...
function CkHttp_getUseBgThread; external DLLName;
procedure CkHttp_putUseBgThread; external DLLName;
...
function CkHttp_AddQuickHeader; external DLLName;
function CkHttp_BgResponseObject; external DLLName;
procedure CkHttp_BgTaskAbort; external DLLName;
procedure CkHttp_ClearBgEventLog; external DLLName;
...
function CkHttp_EventLogName; external DLLName;
function CkHttp__eventLogName; external DLLName;
function CkHttp_EventLogValue; external DLLName;
function CkHttp__eventLogValue; external DLLName;
...
function CkHttp_RemoveQuickHeader; external DLLName;
