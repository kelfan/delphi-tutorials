...
function CkSocket_getAsyncAcceptFinished(objHandle: HCkSocket): wordbool; stdcall;

procedure CkSocket_getAsyncAcceptLog(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncAcceptLog(objHandle: HCkSocket): PWideChar; stdcall;

function CkSocket_getAsyncAcceptSuccess(objHandle: HCkSocket): wordbool; stdcall;

function CkSocket_getAsyncConnectFinished(objHandle: HCkSocket): wordbool; stdcall;

procedure CkSocket_getAsyncConnectLog(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncConnectLog(objHandle: HCkSocket): PWideChar; stdcall;

function CkSocket_getAsyncConnectSuccess(objHandle: HCkSocket): wordbool; stdcall;

function CkSocket_getAsyncDnsFinished(objHandle: HCkSocket): wordbool; stdcall;

procedure CkSocket_getAsyncDnsLog(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncDnsLog(objHandle: HCkSocket): PWideChar; stdcall;

procedure CkSocket_getAsyncDnsResult(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncDnsResult(objHandle: HCkSocket): PWideChar; stdcall;

function CkSocket_getAsyncDnsSuccess(objHandle: HCkSocket): wordbool; stdcall;

procedure CkSocket_getAsyncReceivedBytes(objHandle: HCkSocket; outPropVal: HCkByteData); stdcall;

procedure CkSocket_getAsyncReceivedString(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncReceivedString(objHandle: HCkSocket): PWideChar; stdcall;

function CkSocket_getAsyncReceiveFinished(objHandle: HCkSocket): wordbool; stdcall;

procedure CkSocket_getAsyncReceiveLog(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncReceiveLog(objHandle: HCkSocket): PWideChar; stdcall;

function CkSocket_getAsyncReceiveSuccess(objHandle: HCkSocket): wordbool; stdcall;

function CkSocket_getAsyncSendFinished(objHandle: HCkSocket): wordbool; stdcall;

procedure CkSocket_getAsyncSendLog(objHandle: HCkSocket; outPropVal: HCkString); stdcall;

function CkSocket__asyncSendLog(objHandle: HCkSocket): PWideChar; stdcall;

function CkSocket_getAsyncSendSuccess(objHandle: HCkSocket): wordbool; stdcall;
...
function CkSocket_getDebugConnectDelayMs(objHandle: HCkSocket): Integer; stdcall;

procedure CkSocket_putDebugConnectDelayMs(objHandle: HCkSocket; newPropVal: Integer); stdcall;

function CkSocket_getDebugDnsDelayMs(objHandle: HCkSocket): Integer; stdcall;

procedure CkSocket_putDebugDnsDelayMs(objHandle: HCkSocket; newPropVal: Integer); stdcall;
...
procedure CkSocket_AsyncAcceptAbort(objHandle: HCkSocket); stdcall;

function CkSocket_AsyncAcceptSocket(objHandle: HCkSocket): HCkSocket; stdcall;

function CkSocket_AsyncAcceptStart(objHandle: HCkSocket; maxWaitMs: Integer): wordbool; stdcall;

procedure CkSocket_AsyncConnectAbort(objHandle: HCkSocket); stdcall;

function CkSocket_AsyncConnectStart(objHandle: HCkSocket; hostname: PWideChar; port: Integer; ssl: wordbool; maxWaitMs: Integer): wordbool; stdcall;

procedure CkSocket_AsyncDnsAbort(objHandle: HCkSocket); stdcall;

function CkSocket_AsyncDnsStart(objHandle: HCkSocket; hostname: PWideChar; maxWaitMs: Integer): wordbool; stdcall;

procedure CkSocket_AsyncReceiveAbort(objHandle: HCkSocket); stdcall;

function CkSocket_AsyncReceiveBytes(objHandle: HCkSocket): wordbool; stdcall;

function CkSocket_AsyncReceiveBytesN(objHandle: HCkSocket; numBytes: LongWord): wordbool; stdcall;

function CkSocket_AsyncReceiveString(objHandle: HCkSocket): wordbool; stdcall;

function CkSocket_AsyncReceiveToCRLF(objHandle: HCkSocket): wordbool; stdcall;

function CkSocket_AsyncReceiveUntilMatch(objHandle: HCkSocket; matchStr: PWideChar): wordbool; stdcall;

procedure CkSocket_AsyncSendAbort(objHandle: HCkSocket); stdcall;

function CkSocket_AsyncSendByteData(objHandle: HCkSocket; data: HCkByteData): wordbool; stdcall;

function CkSocket_AsyncSendBytes(objHandle: HCkSocket; byteData: HCkByteData): wordbool; stdcall;

function CkSocket_AsyncSendString(objHandle: HCkSocket; stringToSend: PWideChar): wordbool; stdcall;
...
function CkSocket_getAsyncAcceptFinished; external DLLName;
procedure CkSocket_getAsyncAcceptLog; external DLLName;
function CkSocket__asyncAcceptLog; external DLLName;
function CkSocket_getAsyncAcceptSuccess; external DLLName;
function CkSocket_getAsyncConnectFinished; external DLLName;
procedure CkSocket_getAsyncConnectLog; external DLLName;
function CkSocket__asyncConnectLog; external DLLName;
function CkSocket_getAsyncConnectSuccess; external DLLName;
function CkSocket_getAsyncDnsFinished; external DLLName;
procedure CkSocket_getAsyncDnsLog; external DLLName;
function CkSocket__asyncDnsLog; external DLLName;
procedure CkSocket_getAsyncDnsResult; external DLLName;
function CkSocket__asyncDnsResult; external DLLName;
function CkSocket_getAsyncDnsSuccess; external DLLName;
procedure CkSocket_getAsyncReceivedBytes; external DLLName;
procedure CkSocket_getAsyncReceivedString; external DLLName;
function CkSocket__asyncReceivedString; external DLLName;
function CkSocket_getAsyncReceiveFinished; external DLLName;
procedure CkSocket_getAsyncReceiveLog; external DLLName;
function CkSocket__asyncReceiveLog; external DLLName;
function CkSocket_getAsyncReceiveSuccess; external DLLName;
function CkSocket_getAsyncSendFinished; external DLLName;
procedure CkSocket_getAsyncSendLog; external DLLName;
function CkSocket__asyncSendLog; external DLLName;
function CkSocket_getAsyncSendSuccess; external DLLName;
...
function CkSocket_getDebugConnectDelayMs; external DLLName;
procedure CkSocket_putDebugConnectDelayMs; external DLLName;
function CkSocket_getDebugDnsDelayMs; external DLLName;
procedure CkSocket_putDebugDnsDelayMs; external DLLName;
...
procedure CkSocket_AsyncAcceptAbort; external DLLName;
function CkSocket_AsyncAcceptSocket; external DLLName;
function CkSocket_AsyncAcceptStart; external DLLName;
procedure CkSocket_AsyncConnectAbort; external DLLName;
function CkSocket_AsyncConnectStart; external DLLName;
procedure CkSocket_AsyncDnsAbort; external DLLName;
function CkSocket_AsyncDnsStart; external DLLName;
procedure CkSocket_AsyncReceiveAbort; external DLLName;
function CkSocket_AsyncReceiveBytes; external DLLName;
function CkSocket_AsyncReceiveBytesN; external DLLName;
function CkSocket_AsyncReceiveString; external DLLName;
function CkSocket_AsyncReceiveToCRLF; external DLLName;
function CkSocket_AsyncReceiveUntilMatch; external DLLName;
procedure CkSocket_AsyncSendAbort; external DLLName;
function CkSocket_AsyncSendByteData; external DLLName;
function CkSocket_AsyncSendBytes; external DLLName;
function CkSocket_AsyncSendString; external DLLName;
