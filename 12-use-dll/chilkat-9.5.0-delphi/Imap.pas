...
function CkImap_getUidNext(objHandle: HCkImap): Integer; stdcall;

function CkImap_getUidValidity(objHandle: HCkImap): Integer; stdcall;
...
function CkImap_Copy(objHandle: HCkImap; msgId: Integer; bUid: wordbool; copyToMailbox: PWideChar): wordbool; stdcall;

function CkImap_CopyAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool; copyToMailbox: PWideChar): HCkTask; stdcall;
...
function CkImap_FetchFlags(objHandle: HCkImap; msgId: Integer; bUid: wordbool; outStr: HCkString): wordbool; stdcall;

function CkImap__fetchFlags(objHandle: HCkImap; msgId: Integer; bUid: wordbool): PWideChar; stdcall;

function CkImap_FetchFlagsAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool): HCkTask; stdcall;
...
function CkImap_FetchSingle(objHandle: HCkImap; msgId: Integer; bUid: wordbool): HCkEmail; stdcall;

function CkImap_FetchSingleAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool): HCkTask; stdcall;

function CkImap_FetchSingleAsMime(objHandle: HCkImap; msgId: Integer; bUid: wordbool; outStr: HCkString): wordbool; stdcall;

function CkImap__fetchSingleAsMime(objHandle: HCkImap; msgId: Integer; bUid: wordbool): PWideChar; stdcall;

function CkImap_FetchSingleAsMimeAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool): HCkTask; stdcall;

function CkImap_FetchSingleAsMimeSb(objHandle: HCkImap; msgId: Integer; bUid: wordbool; sbMime: HCkStringBuilder): wordbool; stdcall;

function CkImap_FetchSingleAsMimeSbAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool; sbMime: HCkStringBuilder): HCkTask; stdcall;

function CkImap_FetchSingleBd(objHandle: HCkImap; msgId: Integer; bUid: wordbool; mimeData: HCkBinData): wordbool; stdcall;

function CkImap_FetchSingleBdAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool; mimeData: HCkBinData): HCkTask; stdcall;

function CkImap_FetchSingleHeader(objHandle: HCkImap; msgId: Integer; bUid: wordbool): HCkEmail; stdcall;

function CkImap_FetchSingleHeaderAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool): HCkTask; stdcall;

function CkImap_FetchSingleHeaderAsMime(objHandle: HCkImap; msgId: Integer; bUID: wordbool; outStr: HCkString): wordbool; stdcall;

function CkImap__fetchSingleHeaderAsMime(objHandle: HCkImap; msgId: Integer; bUID: wordbool): PWideChar; stdcall;

function CkImap_FetchSingleHeaderAsMimeAsync(objHandle: HCkImap; msgId: Integer; bUID: wordbool): HCkTask; stdcall;
...
function CkImap_SetCSP(objHandle: HCkImap; csp: HCkCsp): wordbool; stdcall;
...
function CkImap_SetFlag(objHandle: HCkImap; msgId: Integer; bUid: wordbool; flagName: PWideChar; value: Integer): wordbool; stdcall;

function CkImap_SetFlagAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool; flagName: PWideChar; value: Integer): HCkTask; stdcall;
...
function CkImap_StoreFlags(objHandle: HCkImap; msgId: Integer; bUid: wordbool; flagNames: PWideChar; value: Integer): wordbool; stdcall;

function CkImap_StoreFlagsAsync(objHandle: HCkImap; msgId: Integer; bUid: wordbool; flagNames: PWideChar; value: Integer): HCkTask; stdcall;
...
function CkImap_SetCSP; external DLLName;
