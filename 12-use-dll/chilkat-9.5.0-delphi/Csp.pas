...
function CkCsp_SetProviderMicrosoftBase(objHandle: HCkCsp): wordbool; stdcall;

function CkCsp_SetProviderMicrosoftEnhanced(objHandle: HCkCsp): wordbool; stdcall;

function CkCsp_SetProviderMicrosoftRsaAes(objHandle: HCkCsp): wordbool; stdcall;

function CkCsp_SetProviderMicrosoftStrong(objHandle: HCkCsp): wordbool; stdcall;
...
function CkCsp_SetProviderMicrosoftBase; external DLLName;
function CkCsp_SetProviderMicrosoftEnhanced; external DLLName;
function CkCsp_SetProviderMicrosoftRsaAes; external DLLName;
function CkCsp_SetProviderMicrosoftStrong; external DLLName;
