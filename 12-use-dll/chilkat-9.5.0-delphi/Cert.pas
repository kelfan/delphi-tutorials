...
function CkCert_LinkPrivateKey(objHandle: HCkCert; keyContainerName: PWideChar; bMachineKeyset: wordbool; bForSigning: wordbool): wordbool; stdcall;
...
function CkCert_LinkPrivateKey; external DLLName;
