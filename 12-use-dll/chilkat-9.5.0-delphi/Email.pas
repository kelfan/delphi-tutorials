...
function CkEmail_GetImapUid(objHandle: HCkEmail): Integer; stdcall;
...
function CkEmail_SetCSP(objHandle: HCkEmail; csp: HCkCsp): wordbool; stdcall;
...
function CkEmail_SetCSP; external DLLName;
