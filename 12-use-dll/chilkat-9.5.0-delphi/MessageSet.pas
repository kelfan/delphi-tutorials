...
function CkMessageSet_ContainsId(objHandle: HCkMessageSet; msgId: Integer): wordbool; stdcall;

function CkMessageSet_FromCompactString(objHandle: HCkMessageSet; str: PWideChar): wordbool; stdcall;

function CkMessageSet_GetId(objHandle: HCkMessageSet; index: Integer): Integer; stdcall;

procedure CkMessageSet_InsertId(objHandle: HCkMessageSet; id: Integer); stdcall;

function CkMessageSet_LoadTaskResult(objHandle: HCkMessageSet; task: HCkTask): wordbool; stdcall;

procedure CkMessageSet_RemoveId(objHandle: HCkMessageSet; id: Integer); stdcall;
