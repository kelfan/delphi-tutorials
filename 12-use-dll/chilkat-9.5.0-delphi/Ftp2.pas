...
function CkFtp2_getAsyncFinished(objHandle: HCkFtp2): wordbool; stdcall;

procedure CkFtp2_getAsyncLog(objHandle: HCkFtp2; outPropVal: HCkString); stdcall;

function CkFtp2__asyncLog(objHandle: HCkFtp2): PWideChar; stdcall;

function CkFtp2_getAsyncPercentDone(objHandle: HCkFtp2): LongWord; stdcall;

function CkFtp2_getAsyncSuccess(objHandle: HCkFtp2): wordbool; stdcall;
...
function CkFtp2_getSendBufferSize(objHandle: HCkFtp2): Integer; stdcall;

procedure CkFtp2_putSendBufferSize(objHandle: HCkFtp2; newPropVal: Integer); stdcall;
...
function CkFtp2_getSkipFinalReply(objHandle: HCkFtp2): wordbool; stdcall;

procedure CkFtp2_putSkipFinalReply(objHandle: HCkFtp2; newPropVal: wordbool); stdcall;
...
procedure CkFtp2_AsyncAbort(objHandle: HCkFtp2); stdcall;

function CkFtp2_AsyncAppendFileStart(objHandle: HCkFtp2; localFilename: PWideChar; remoteFilename: PWideChar): wordbool; stdcall;

function CkFtp2_AsyncGetFileStart(objHandle: HCkFtp2; remoteFilename: PWideChar; localFilename: PWideChar): wordbool; stdcall;

function CkFtp2_AsyncPutFileStart(objHandle: HCkFtp2; localFilename: PWideChar; remoteFilename: PWideChar): wordbool; stdcall;
...
function CkFtp2_GetLastAccessDt(objHandle: HCkFtp2; index: Integer): HCkDateTime; stdcall;

function CkFtp2_GetLastAccessDtAsync(objHandle: HCkFtp2; index: Integer): HCkTask; stdcall;

function CkFtp2_GetLastAccessDtByName(objHandle: HCkFtp2; filename: PWideChar): HCkDateTime; stdcall;

function CkFtp2_GetLastAccessDtByNameAsync(objHandle: HCkFtp2; filename: PWideChar): HCkTask; stdcall;

function CkFtp2_GetLastAccessTimeByNameStr(objHandle: HCkFtp2; filename: PWideChar; outStr: HCkString): wordbool; stdcall;

function CkFtp2__getLastAccessTimeByNameStr(objHandle: HCkFtp2; filename: PWideChar): PWideChar; stdcall;

function CkFtp2_GetLastAccessTimeByNameStrAsync(objHandle: HCkFtp2; filename: PWideChar): HCkTask; stdcall;

function CkFtp2_GetLastAccessTimeStr(objHandle: HCkFtp2; index: Integer; outStr: HCkString): wordbool; stdcall;

function CkFtp2__getLastAccessTimeStr(objHandle: HCkFtp2; index: Integer): PWideChar; stdcall;

function CkFtp2_GetLastAccessTimeStrAsync(objHandle: HCkFtp2; index: Integer): HCkTask; stdcall;
...
function CkFtp2_getAsyncFinished; external DLLName;
procedure CkFtp2_getAsyncLog; external DLLName;
function CkFtp2__asyncLog; external DLLName;
function CkFtp2_getAsyncPercentDone; external DLLName;
function CkFtp2_getAsyncSuccess; external DLLName;
...
function CkFtp2_getSendBufferSize; external DLLName;
procedure CkFtp2_putSendBufferSize; external DLLName;
procedure CkFtp2_getSessionLog; external DLLName;
function CkFtp2__sessionLog; external DLLName;
function CkFtp2_getSkipFinalReply; external DLLName;
procedure CkFtp2_putSkipFinalReply; external DLLName;
...
procedure CkFtp2_AsyncAbort; external DLLName;
function CkFtp2_AsyncAppendFileStart; external DLLName;
function CkFtp2_AsyncGetFileStart; external DLLName;
function CkFtp2_AsyncPutFileStart; external DLLName;
...
function CkFtp2_GetLastAccessDt; external DLLName;
function CkFtp2_GetLastAccessDtAsync; external DLLName;
function CkFtp2_GetLastAccessDtByName; external DLLName;
function CkFtp2_GetLastAccessDtByNameAsync; external DLLName;
function CkFtp2_GetLastAccessTimeByNameStr; external DLLName;
function CkFtp2__getLastAccessTimeByNameStr; external DLLName;
function CkFtp2_GetLastAccessTimeByNameStrAsync; external DLLName;
function CkFtp2_GetLastAccessTimeStr; external DLLName;
function CkFtp2__getLastAccessTimeStr; external DLLName;
function CkFtp2_GetLastAccessTimeStrAsync; external DLLName;
