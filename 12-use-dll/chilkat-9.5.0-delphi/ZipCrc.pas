...
function CkZipCrc_ToHex(objHandle: HCkZipCrc; crc: Integer; outStr: HCkString): wordbool; stdcall;

function CkZipCrc__toHex(objHandle: HCkZipCrc; crc: Integer): PWideChar; stdcall;
